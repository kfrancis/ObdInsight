namespace ObdInsight.Core.Communication.Elm327
{
    ...
    /// </summary>
    /// <remarks>
    ///     Implementations of this interface are responsible for managing the underlying connection
    ...
    ///     methods are asynchronous and support cancellation via a CancellationToken.
    /// </remarks>
    public interface IElmTransport : IAsyncDisposable
    {
        ...
        /// </summary>
        /// <param name="buffer">
        ///     The region of memory to write the data into. The method attempts to fill this buffer with data read from the
        ///     stream.
        /// </param>
        /// <param name="ct">A cancellation token that can be used to cancel the asynchronous read operation.</param>
        /// <returns>
        ///     A value task representing the asynchronous read operation. The result contains the total number of bytes
        ///     read into the buffer. The result is 0 if the end of the stream has been reached.
        /// </returns>

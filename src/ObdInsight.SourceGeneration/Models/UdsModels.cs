...
internal sealed class UdsPidModel
{
    ...
    /// </summary>
    /// <remarks>
    ///     Each field in the collection represents a custom data element. Modifying the collection
    ///     affects the set of fields available for this model. The order of fields in the list may be significant depending
    ///     on how the model is processed.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     Each variant represents an alternative response option. Modifying this collection affects
    ///     which variants are available for selection or processing.
    /// </remarks>
...
internal sealed class UdsServiceModel
{
    ...
    /// </summary>
    /// <remarks>
    ///     Each item in the collection represents a diagnostic parameter available for querying or
    ///     reporting. Modifying this list affects which PIDs are exposed by the model.
    /// </remarks>
...
internal sealed class UdsFieldModel
{
    ...
    /// </summary>
    /// <remarks>
    ///     The format and interpretation of the range string may vary depending on the context in which
    ///     this property is used. If no range is specified, the property value may be null.
    /// </remarks>

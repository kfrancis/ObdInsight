# ObdInsight TUnit Tests

This test project contains unit and integration tests for the ObdInsight application, specifically focused on Nissan Leaf vehicle testing and BMS (Battery Management System) data parsing.
